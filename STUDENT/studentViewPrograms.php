...
<!--End Page Header-->
<?php
$qry = "SELECT `programme`.*,`councellor`.* FROM `programme`,`councellor` WHERE `councellor`.`cid`=`programme`.`cid`";
...
if (mysqli_num_rows($result) < 1) {
    ...
    <center>
        <h1 class="m-3 bread">Scheduled Programs</h1>
        <input type="text" class="form-control m-3" id="searchInput" style="width: 99%;" placeholder="Search...">
            ...
            <tbody id="tableBody">
                ...
                while ($row = mysqli_fetch_array($result)) {
                    ...
                    <tr id="row{{ forloop.counter }}" style="text-align: center;">
                        ...
                        <td>
                            <a href="bookProgram.php?id=<?php echo $row['pid'] ?>" class="btn btn-outline-primary">Book</a>
                        </td>
                    </tr>
                    <?php
                }
