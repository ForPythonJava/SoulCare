...
<?php
$qry = "SELECT `individual_booking`.*,`student`.*,`councellor`.`name` AS cname FROM `individual_booking` ,`student`,`councellor` WHERE `individual_booking`.`sid`=`student`.`sid` AND `councellor`.`cid`=`individual_booking`.`cid` AND `individual_booking`.`cid`='$uid'";
...
?>
    <center>
        <h1 class="m-3 bread">Bookings</h1>
